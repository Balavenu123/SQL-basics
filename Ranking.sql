...
SELECT EMPID,EMPNAME,EMPSALARY,ROW_NUMBER() OVER (ORDER BY EMPSALARY ASC) FROM EMPLOYEE

SELECT EMPID,EMPNAME,EMPSALARY,RANK() OVER (ORDER BY EMPSALARY ASC) FROM EMPLOYEE
...
INSERT INTO EMPLOYEE VALUES (3,'PPPP',-1200)
